#ifndef LINUX_KEY_CODES_H
#define LINUX_KEY_CODES_H

/**
 * @file linux_key_codes.h
 * @brief Mapeamento de teclas do windows para linux (Usando X11. @TODO se livrar do X11)
 */
