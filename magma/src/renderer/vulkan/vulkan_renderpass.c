                              ...
                              f32 depth, u32 stencil)
{
    ...
    // @TODO: mais anexos! (input, resolve, preserve, ...)
    ...
    VK_CHECK(vkCreateRenderPass(context->device.logical_device, &renderpass_create_info, context->allocator, &renderpass->handle));
}
...
void begin_vulkan_renderpass(vulkan_command_buffer* command_buffer, vulkan_renderpass* renderpass, VkFramebuffer frame_buffer)
{
    ...
    mgm_zero_memory(clear_values, sizeof(VkClearValue) * 2);
